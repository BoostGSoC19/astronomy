...
//!constructs object from any type of cartesian representation
template 
<
    typename OtherCoordinateType,
    typename XQuantity,
...
)
{
    ...
    bg::set<1>(tempPoint, static_cast<XQuantity>(other.get_y()).value());
    bg::set<2>(tempPoint, static_cast<XQuantity>(other.get_z()).value());
...
//!constructs object from any type of spherical representation
...
>
make_spherical_equatorial_representation(OtherRepresentation const& other)
{
