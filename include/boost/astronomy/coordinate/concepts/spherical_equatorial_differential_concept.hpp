#ifndef BOOST_ASTRONOMY_COORDINATE_CONCEPTS_SPHERICAL_EQUATORIAL_DIFFERENTIAL_CONCEPT_HPP
#define BOOST_ASTRONOMY_COORDINATE_CONCEPTS_SPHERICAL_EQUATORIAL_DIFFERENTIAL_CONCEPT_HPP

//!Header for Spherical Equatorial Differential concept checking class
...
//!Concept checking class for Spherical Equatorial Differential
template<typename Differential>
class Spherical_Equatorial_Differential : Base_Differential<Differential>
{
private:
...
public:
	...
	BOOST_CONCEPT_USAGE(Spherical_Equatorial_Differential)
	{
		//Asserting the point as Spherical Equatorial
		BOOST_STATIC_ASSERT_MSG(isSphericalEquatorialPoint,
            "Spherical Equatorial differential required");
	}
};

}}}} //namespace boost::astronomy::coordinate::concepts

#endif // !BOOST_ASTRONOMY_COORDINATE_CONCEPTS_SPHERICAL_EQUATORIAL_DIFFERENTIAL_CONCEPT_HPP