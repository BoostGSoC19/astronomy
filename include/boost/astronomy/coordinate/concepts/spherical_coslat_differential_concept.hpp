#ifndef BOOST_ASTRONOMY_COORDINATE_CONCEPTS_SPHERICAL_COSLAT_DIFFERENTIAL_CONCEPT_HPP
#define BOOST_ASTRONOMY_COORDINATE_CONCEPTS_SPHERICAL_COSLAT_DIFFERENTIAL_CONCEPT_HPP

//!Header for Spherical coslat differential concept checking class
...
//!Concept checking class for Spherical Coslat Differential
template<typename Differential>
class Spherical_Coslat_Differential : Base_Differential<Differential>
{
private:
...
public:
	...
	BOOST_CONCEPT_USAGE(Spherical_Coslat_Differential)
	{
		//Asserting the point as Spherical
		BOOST_STATIC_ASSERT_MSG(isSphericalPoint,"Spherical point required");
	}
};

}}}} //namespace boost::astronomy::coordinate::concepts

#endif // !BOOST_ASTRONOMY_COORDINATE_CONCEPTS_SPHERICAL_COSLAT_DIFFERENTIAL_CONCEPT_HPP